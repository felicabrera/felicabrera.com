...
const ProjectCard = ({ title, category, description, year, url }) => (
    <a href={url} target="_blank" rel="noopener noreferrer" data-ga={`project:${title}`} className="block group/item border-b border-white/5 last:border-0 py-4 first:pt-0">
