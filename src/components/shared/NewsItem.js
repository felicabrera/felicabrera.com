...
const NewsItem = ({ source, headline, date, url }) => (
    <a href={url} target="_blank" rel="noopener noreferrer" data-ga={`news:${source}-${date}`} className="flex flex-col py-3 border-b border-white/5 last:border-0 group hover:bg-white/[0.02] -mx-4 px-4 transition-colors">
